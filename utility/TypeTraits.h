...
////////////////////////////////////////////////////////////////////////////////
    ...
    namespace Private
    {
        ...
        typedef LOKI_TYPELIST_3(float, double, long double) 
            StdFloats;
#else
        typedef Seq<unsigned char, unsigned short int,unsigned int, unsigned long int>::Type
            StdUnsignedInts;
        typedef Seq<signed char, short int,int, long int>::Type
            StdSignedInts;
        typedef Seq<bool, char, wchar_t>::Type
            StdOtherInts;
        typedef Seq<float, double, long double>::Type
            StdFloats;
